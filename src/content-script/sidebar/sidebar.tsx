...
export const Sidebar = sidebar(({ className, plugins = mock }: Props) => {
  ...
  return (
    <div className={className}>
      ...
      <DrillLogo align="center">
        <svg width="16px" height="16px" viewBox="0 0 16 16">
          <g id="Logo_16x16" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
const Agent = sidebar.agent(Panel);
const Logo = sidebar.logo(Icons.UnicornWithCircle);
const PluginsLinks = sidebar.pluginsList('div');
const PluginItem = sidebar.pluginItem(div({ onClick: () => {} } as {active?: boolean}));
const DrillLogo = sidebar.drillLogo(Panel);
